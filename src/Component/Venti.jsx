...
const WindAndCurrentsMap = () => {
  ...
  useEffect(() => {
    ...
    // Mappa delle Correnti Marine
    if (!currentsMapRef.current) {
      const currentsMap = L.map('currentsMap').setView([0, 0], 2);
      L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png').addTo(currentsMap);

      currentsMapRef.current = currentsMap;
    }
  }, []);
  ...
  return (
    ...
    <div className='maps-container'>
      <div id="windMap" style={{ width: '600px', height: '370px' }} />
      <div id="currentsMap" style={{ width: '600px', height: '370px' }} />
    </div>
  );
};
